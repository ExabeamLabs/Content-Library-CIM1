...
#### New Parsers
* [azure-ad-member-removed-1](https://github.com/ExabeamLabs/Content-Doc/search?q=azure-ad-member-removed-1)
...
* [azure-app-logon-3](https://github.com/ExabeamLabs/Content-Doc/search?q=azure-app-logon-3)

* [azure-event-hub-remote-logon](https://github.com/ExabeamLabs/Content-Doc/search?q=azure-event-hub-remote-logon)
...
* [cef-aws-redshift-db-query](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-aws-redshift-db-query)

* [cef-bitglass-app-login-1](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-bitglass-app-login-1)

* [cef-box-app-login](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-box-app-login)

* [cef-exchange-scanmail-alert](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-exchange-scanmail-alert)

* [cef-google-app-login-1](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-google-app-login-1)

* [cef-sophos-security-alert-41](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-sophos-security-alert-41)

* [cef-unix-account-1](https://github.com/ExabeamLabs/Content-Doc/search?q=cef-unix-account-1)

* [checkpoint-connectra-vpn-login-1](https://github.com/ExabeamLabs/Content-Doc/search?q=checkpoint-connectra-vpn-login-1)

* [cisco-wsa-web-activity-1](https://github.com/ExabeamLabs/Content-Doc/search?q=cisco-wsa-web-activity-1)

* [forcepoint-network-connection-7](https://github.com/ExabeamLabs/Content-Doc/search?q=forcepoint-network-connection-7)

* [gallagher-failed-physical-access](https://github.com/ExabeamLabs/Content-Doc/search?q=gallagher-failed-physical-access)

* [gallagher-physical-access-1](https://github.com/ExabeamLabs/Content-Doc/search?q=gallagher-physical-access-1)

* [gallagher-physical-access](https://github.com/ExabeamLabs/Content-Doc/search?q=gallagher-physical-access)

* [illumio-network-connection-1](https://github.com/ExabeamLabs/Content-Doc/search?q=illumio-network-connection-1)

* [imperva-attack-analytics-network-alert](https://github.com/ExabeamLabs/Content-Doc/search?q=imperva-attack-analytics-network-alert)

* [infoblox-nios-dns-query](https://github.com/ExabeamLabs/Content-Doc/search?q=infoblox-nios-dns-query)

* [leef-eset-web-activity-denied-1](https://github.com/ExabeamLabs/Content-Doc/search?q=leef-eset-web-activity-denied-1)

* [leef-pan-vpn-logout](https://github.com/ExabeamLabs/Content-Doc/search?q=leef-pan-vpn-logout)

* [leef-pan-vpn-start](https://github.com/ExabeamLabs/Content-Doc/search?q=leef-pan-vpn-start)

* [mariadb-connect-1](https://github.com/ExabeamLabs/Content-Doc/search?q=mariadb-connect-1)

* [mariadb-failedconnect](https://github.com/ExabeamLabs/Content-Doc/search?q=mariadb-failedconnect)

* [mariadb-read-1](https://github.com/ExabeamLabs/Content-Doc/search?q=mariadb-read-1)

* [mariadb-write-1](https://github.com/ExabeamLabs/Content-Doc/search?q=mariadb-write-1)

* [microsoft-cloud-app-dlp-alert](https://github.com/ExabeamLabs/Content-Doc/search?q=microsoft-cloud-app-dlp-alert)

* [o365-dlp-rule-undo-activity](https://github.com/ExabeamLabs/Content-Doc/search?q=o365-dlp-rule-undo-activity)

* [paloalto-app-activity-1](https://github.com/ExabeamLabs/Content-Doc/search?q=paloalto-app-activity-1)

* [paloalto-app-activity-2](https://github.com/ExabeamLabs/Content-Doc/search?q=paloalto-app-activity-2)
...
* [s-aws-s3-cloud-storage-activity](https://github.com/ExabeamLabs/Content-Doc/search?q=s-aws-s3-cloud-storage-activity)

* [sentinelone-process-alert](https://github.com/ExabeamLabs/Content-Doc/search?q=sentinelone-process-alert)

* [unix-ssh-login-json-1](https://github.com/ExabeamLabs/Content-Doc/search?q=unix-ssh-login-json-1)

* [windows-dns-query-4](https://github.com/ExabeamLabs/Content-Doc/search?q=windows-dns-query-4)

* [windows-dns-query-5](https://github.com/ExabeamLabs/Content-Doc/search?q=windows-dns-query-5)

* [windows-dns-response-3](https://github.com/ExabeamLabs/Content-Doc/search?q=windows-dns-response-3)

* [xml-1009](https://github.com/ExabeamLabs/Content-Doc/search?q=xml-1009)

* [xml-1116](https://github.com/ExabeamLabs/Content-Doc/search?q=xml-1116)

* [xml-1117](https://github.com/ExabeamLabs/Content-Doc/search?q=xml-1117)

* [zscaler-firewall-1](https://github.com/ExabeamLabs/Content-Doc/search?q=zscaler-firewall-1)
