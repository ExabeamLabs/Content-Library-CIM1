...
Name = f5-asm-alert-4
  ...
  Fields = [
    ...
    """\sASM:("[^"]{0,2000}",){1}"({dest_ip}[\da-fA-F\.:]{1,2000})""",
    """\sASM:("[^"]{0,2000}",){2}"({dest_port}\d{1,2000})""",
    """\sASM:("[^"]{0,2000}",){4}"({alert_name}[^"]{1,2000})"""",
    """\sASM:("[^"]{0,2000}",){6}"\w+\s{1,100}({malware_url}[^"]{1,2000}?)\s{1,100}(({protocol}\w+)\/\d\.\d|)((\\r\\n|\s{1,100})[\w\-]{1,2000}:|")""",
