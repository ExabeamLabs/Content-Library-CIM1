...
Name = paloalto-firewall-drop
    ...
    DupFields = [ "action->outcome", "src_user->user" ]
...
paloalto-firewall = {
   ...
   Fields = [
     ...
     """TRAFFIC,([^,]{0,2000},){18}({session_id}\d{1,20}),""",
     """TRAFFIC,("[^"]{0,2000}",|[^,]{0,2000},){48}({src_host}[\w\-\.]{1,2000})""", 
     """TRAFFIC,([^,]{0,2000},){14}({src_interface}[^,]{1,2000}),""",
     """TRAFFIC,([^,]{0,2000},){15}({dest_interface}[^,]{1,2000}),""",
     """TRAFFIC,([^,]{0,2000},){42}({reason}[^,]{1,2000}),"""
