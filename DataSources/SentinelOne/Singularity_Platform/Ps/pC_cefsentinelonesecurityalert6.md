...
Name = cef-sentinelone-security-alert-6
  ...
  Fields = [
     ...
     """"action":"({action}quarantine)".{0,2000}?"status":"({quarantine_status}\w{1,2000})"""",
     """"action":"({action1}kill)".{0,2000}?"status":"({kill_status}\w{1,2000})"""",
     ...
     """"confidenceLevel":"({category}[^"]{1,2000})"""
  ]
   SOAR {
