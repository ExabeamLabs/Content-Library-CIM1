...
```Java
{
Name = json-defender-atp-security-alert-15
    Conditions = [ """"category":"SuspiciousActivity"""", """"title":""", """"incidentId":""", """"detectionSource":""", """"serviceSource":""", """"microsoftDefenderFor""" ]
    Fields = ${MicrosoftParserTemplates.json-microsoft-security-events-1.Fields} [
      """"alertWebUrl":"({malware_url}[^"]{1,2000})"""",
      """"incidentId":"({alert_id}[^"]{1,2000})""",
      """"detectionSource":"({alert_source}[^"]{1,2000})""""
   ] 
