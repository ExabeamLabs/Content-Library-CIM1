...
```Java
{
Name = azure-atp-security-alert-8
  Product = Azure Advanced Threat Protection
  DataType = "alert"
  TimeFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSSSSSZ"
  Conditions = [ """"category":""", """"EnumerateSessionsSecurityAlert"""", """"title":""", """"vendor":""", """"Microsoft"""", """"provider":""", """"Azure Advanced Threat Protection"""", """"sourcetype":"GraphSecurityAlert""""  ]
