...
Name = cef-o365-app-login-1
    ...
    Fields = [
      ...
      """"userDisplayName":"\{?(On-Premises Directory Synchronization Service Account|({user_fullname}({user_firstname}[^\s"]{1,2000}?)\s{1,100}({user_lastname}[^"\(\),\-]{1,2000})))(\s{1,100}[^"]{0,2000}?"|")""",
