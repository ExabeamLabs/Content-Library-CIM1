...
Name = cef-cisco-dns-response-sk4-ad-users
  ...
  Fields=${CiscoParsersTemplates.cef-cisco-dns-response-sk4-src-template.Fields}[
    """"mostGranularIdentity":"({user_fullname}\w{1,2000}\,?\s{1,100}\w{1,2000}?[^\("]{1,2000}?)(?:\s{0,100}\(\w+\)\s{0,100})?\s{1,100}((\([^\)]{1,2000}\))\s\(|\()(({user_email}[^@"]{1,2000}@[^@"]{1,2000})|({user}[^"]{1,2000}))\)"""",
   """"mostGranularIdentity":"({user}[^\s]{1,2000})\s{1,100}\(""",
  ]
