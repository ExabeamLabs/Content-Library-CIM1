...
```Java
{
Name = duo-app-activity-8
  Conditions = [ """ duo: """, """|admin_update|""", """": """" ]
  Fields = ${DuoParserTemplates.duo-app-activity-2.Fields}[
    """"password":\s{0,10}"({additional_info}[^"]{1,2000})"""",
    """"hardtoken":\s{0,10}"({additional_info}[^"]{1,2000})""""
  ]
