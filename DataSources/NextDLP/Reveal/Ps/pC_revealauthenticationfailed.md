...
```Java
{
Name = reveal-authentication-failed
  Vendor = NextDLP
  DataType = "authentication-failed"
  Conditions = [ """reveal""", """Login with unauthorized account""", """"tags":""", """"unusualbehavior"""", """"sensor_type": "AGENT_POLICY"""", """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({activity}login)"""
    """"anonymised_description":\s{0,100}"({failure_reason}[^"]{1,2000})""""
  ]
