...
```Java
{
Name = reveal-security-alert
  Vendor = NextDLP
  DataType = "alert"
  Conditions = [ """reveal""", """Suspicious Windows commands executed""", """"tags":""", """"attackindicator"""", """"sensor_type": "AGENT_POLICY"""", """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({activity}Windows commands executed)"""
    """({alert_type}attackindicator)"""
    """({alert_name}Suspicious Windows commands executed)"""
  ]
