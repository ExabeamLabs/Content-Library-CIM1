...
```Java
{
Name = reveal-usb-insert-1
  Vendor = NextDLP
  DataType = "usb-insert"
  Conditions = [ """reveal""", """Unauthorized USB device inserted""", """"tags":""", """"investeccyberhygiene"""", """"sensor_type": "AGENT_POLICY"""", """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({activity}USB device inserted)"""
    """"usb_vid":\s{0,100}\["({device_id}[^"]{1,1000})"""
  ]
