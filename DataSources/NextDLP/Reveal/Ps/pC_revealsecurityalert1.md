...
```Java
{
Name = reveal-security-alert-1
  Vendor = NextDLP
  DataType = "alert"
  Conditions = [ """reveal""", """logins""", """"tags":""", """"attackindicator"""", """"sensor_type": "MULTIPLE_LOGIN"""", """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({alert_type}Investecattackindicator)"""
    """({alert_name}MULTIPLE_LOGIN)"""
    """({activity}login)"""
  ]
