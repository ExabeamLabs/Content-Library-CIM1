...
```Java
{
Name = reveal-nac-logon-1
  Vendor = NextDLP
  DataType = "network-connection-successful"
  Conditions = [ """reveal""", """"wifi"""", """"tags":""", """Wi-Fi network""", """"sensor_type": """, """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({activity}Connection made)""",
    """({event_name}This node connected to Wi-Fi network)""",
  ]
