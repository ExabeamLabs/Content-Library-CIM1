...
```Java
{
Name = reveal-security-alert-2
  Vendor = NextDLP
  DataType = "alert"
  Conditions = [ """reveal""", """logins""", """"tags":""", """"attackindicator"""", """"sensor_type": "AGENT_POLICY"""", """name":""" ]
  Fields = ${QUSHRevealParserTemplates.json-qush-reveal.Fields} [
    """({alert_type}investecdatatracking)"""
    """({alert_name}Intellectual Property uploaded)"""
    """({activity}dataupload)"""
  ]
