...
```Java
{
Name = cef-aws-guardduty-security-alert-2
  Conditions = [ """CEF:""", """destinationServiceName =AWS""", """"awsApiCallAction":""", """"serviceName":"guardduty"""", """"type":"UnauthorizedAccess:IAMUser/TorIPCaller"""" ]
...
cef-aws-guardduty-security-alert-template = {
    ...
    Fields = [
      ...
      """resource":[^}]{1,2000}principalId":\s{0,100}"([^},]{1,2000}?(:({user_email}[^@]{1,2000}@[^},]{1,2000}))?)"""",
      """resource":[^}]{1,2000}"userName":\s{0,100}"({user}[^},]{1,2000}?)"""",
      """resource":[^}]{1,2000}"userType":\s{0,100}"({user_type}[^},]{1,2000}?)"""",
